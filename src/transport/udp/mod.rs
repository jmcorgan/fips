...
async fn udp_receive_loop(
    ...
    #[cfg(target_os = "linux")]
    {
        ...
        // One Vec per recvmmsg slot. When a packet lands, move the filled
        // buffer directly into ReceivedPacket and install a fresh empty buffer
        // for the next syscall, avoiding a per-packet memcpy.
