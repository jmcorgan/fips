...
[![Status](https://img.shields.io/badge/status-v1.0.0--dev-green.svg)](#status--roadmap)
...
[v0.5.0](https://github.com/jmcorgan/fips/releases/tag/v0.5.0)
has shipped from `master`; this development line carries
wire-format-breaking work for v1.0.0 — unified Noise XX handshake
...
v0.2.x, v0.3.x, v0.4.x, or v0.5.x peers. The core protocol works end-to-end
over UDP, TCP, Ethernet, Tor, Nym, and Bluetooth on a global, public test
mesh of thousands of nodes. See the CHANGELOG `## Breaking` section for the
full list of v1.0.0 wire-format changes in flight.
